    ...
    static public function addtodotask($data)
{
    ...
    $query = "INSERT INTO task (task_descr, task_end, statut, user_id, project_id)
              VALUES (:task_descr, :task_end, 'todo', :user, :project_id)";
    $statement = $db->prepare($query);

    $userId = $_SESSION['id'];

    $statement->bindParam(':task_descr', $data['task_descr']);
    $statement->bindParam(':user', $userId);
    $statement->bindParam(':task_end', $data['task_end']);
